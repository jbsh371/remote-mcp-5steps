...
이전 안정판(3.4.7) 동결본은 저장소에 두지 않습니다. 두 세대가 같은 코드 묶음을 쓰기 때문입니다. **이 코드는 `3.4.7`·`4.0.3`에서 점검 53개를 전부 통과합니다**(2026-09-11). 첫 베타 `4.0.0b2`에서는 점검이 50개이던 때 전부 통과했습니다. 책이 4.0.3 을 기준으로 삼은 이유는 코드가 아니라 규격입니다 - 3.4.x 는 2026-07-28 개정 이전 세대입니다.
...
| `test_smoke.py` | - | 다섯 단계 점검 + 경계 점검 (53항목) |
...
| 무엇 | 3.4.7 | 4.0.3 |
|---|---|---|
| 이 저장소 코드 | **53항목 통과** (2026-09-11 외부 검토 실행. mcp 1.30.0) | **53항목 통과** (2026-09-11. mcp 2.1.1) |
